...
define('ADMIN_USERNAME','yoka'); 	// Admin Username
define('ADMIN_PASSWORD','yoka.com');  	// Admin Password
define('DATE_FORMAT','Y/m/d H:i:s');
define('GRAPH_SIZE',200);
define('MAX_ITEM_DUMP',50);

$MEMCACHE_SERVERS[] = '10.0.0.211:11211'; // add more as an array
$MEMCACHE_SERVERS[] = '10.0.0.211:11212'; // add more as an array
$MEMCACHE_SERVERS[] = '10.0.0.211:11213'; // add more as an array
$MEMCACHE_SERVERS[] = '10.0.0.211:11214'; // add more as an array
$MEMCACHE_SERVERS[] = '10.0.0.211:11215'; // add more as an array
$MEMCACHE_SERVERS[] = '10.0.0.211:11216'; // add more as an array
$MEMCACHE_SERVERS[] = '10.0.0.211:11217'; // add more as an array
$MEMCACHE_SERVERS[] = '10.0.0.211:22222'; // add more as an array
$MEMCACHE_SERVERS[] = '10.0.0.211:33333'; // add more as an array
$MEMCACHE_SERVERS[] = '10.0.0.211:55555'; // add more as an array
$MEMCACHE_SERVERS[] = '10.0.0.92:11411'; // add more as an array
$MEMCACHE_SERVERS[] = '10.0.0.93:11411'; // add more as an array
$MEMCACHE_SERVERS[] = '10.0.0.95:11411'; // add more as an array
