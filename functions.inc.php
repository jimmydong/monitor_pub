...
function showhead($title="")
{
    ...
    print <<< end_of_print
        <html>
        <head>
        <title>SOHU Club - Jimmy Tool Kit - $title</title>
...
function showhead_monitor($title="")
{
    ...
    print <<< end_of_print
        <html>
        <head>
        <title> YOKA服务器管理与监控系统 $title</title>
        <META HTTP-EQUIV="Expires" CONTENT="0">
        <META HTTP-EQUIV="Last-Modified" CONTENT="0">
        <META HTTP-EQUIV="Cache-Control" CONTENT="no-cache, must-revalidate">
        <META HTTP-EQUIV="Pragma" CONTENT="no-cache">
        ...
        <body bgcolor="#FFFFFF" text="#000000" topmargin="10" background="/include/bg.gif" >
        <p><a href=new_index.php>返回首页</a> | <a href=tools_server.php>脚本快速生成工具</a> 
        	| <a href=tools_servername.php>服务器信息管理</a> | <a href=tools_mt.php>监测类型管理</a> 
          | <a href=tools_monitor.php>监测配置设定</a> | <a href=new_monitor_server.php>监控项目-服务器</a> 
          | <a href=new_server_monitor.php>服务器-监控项目</a> | <a href=tools_clean.php>数据清理</a> 
          其他工具： 
