...
end_of_print;
        ...
        switch($_REQUEST['ctype']){
				...
				case 'brand_service': 
				case 'brand': 
					$host=$_REQUEST['host'] ? $_REQUEST['host'] : 'brand.yoka.com';
					$file=$_REQUEST['file'] ? $_REQUEST['file'] : '/';
					$ip_list=array('lvs'=>'59.151.9.75', '10.0.0.12', '10.0.0.13', '10.0.0.14');
					$log_file='check_brand.log';break;
				case 'brandcenter':
				case 'watch':
				case 'try':
					$host=$_REQUEST['host'] ? $_REQUEST['host'] : 'try.yoka.com';
					$file=$_REQUEST['file'] ? $_REQUEST['file'] : '/';
					$ip_list=array('lvs'=>'59.151.9.76', '10.0.0.63','10.0.0.64','10.0.0.55','10.0.0.56');
					$log_file='check_try.log';break;
				case 'baida':
					$host=$_REQUEST['host'] ? $_REQUEST['host'] : 'baida.yoka.com';
					$file=$_REQUEST['file'] ? $_REQUEST['file'] : '/';
					$ip_list=array('lvs'=>'59.151.9.103', '10.0.0.92','10.0.0.93','10.0.0.98');
					$log_file='check_baida.log';break;
				case 'sec':
				case 'lucky':
				case 'star':
				case 'vote_sec':
				case 'street':
					$host=$_REQUEST['host'] ? $_REQUEST['host'] : 'street.yoka.com';
					$file=$_REQUEST['file'] ? $_REQUEST['file'] : '/';
					$ip_list=array('lvs'=>'59.151.9.80', '10.0.0.82','10.0.0.83');
					$log_file='check_baida.log';break;
				case 'advlog':
					$host=$_REQUEST['host'] ? $_REQUEST['host'] : 'advlog10.yoka.com';
					$file=$_REQUEST['file'] ? $_REQUEST['file'] : '/';
					$ip_list=array('lvs'=>'59.151.9.124', '10.0.0.125','10.0.0.126');
					$log_file='check_advlog.log';break;
				case 'www': 
				default: 
